...
public class DictionaryLocalServiceClpInvoker {
	public DictionaryLocalServiceClpInvoker() {
		...
		_methodParameterTypes0 = new String[] {
				"edu.ucla.macroscope.emotiongraph.model.Dictionary"
			};
		...
		_methodName16 = "getContentsBlobModel";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return DictionaryLocalServiceUtil.addDictionary((edu.ucla.macroscope.emotiongraph.model.Dictionary)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return DictionaryLocalServiceUtil.deleteDictionary((edu.ucla.macroscope.emotiongraph.model.Dictionary)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return DictionaryLocalServiceUtil.updateDictionary((edu.ucla.macroscope.emotiongraph.model.Dictionary)arguments[0]);
		}

		if (_methodName16.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes16, parameterTypes)) {
			return DictionaryLocalServiceUtil.getContentsBlobModel((java.io.Serializable)arguments[0]);
		}
