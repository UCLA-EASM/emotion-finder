...
import edu.ucla.macroscope.emotiongraph.service.JobService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.ucla.macroscope.emotiongraph.service.impl.JobServiceImpl}.
 * </p>
 *
 * @author dave
...
public abstract class JobServiceBaseImpl extends BaseServiceImpl
	implements JobService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link edu.ucla.macroscope.emotiongraph.service.JobServiceUtil} to access the job remote service.
	 */
	...
	private JobServiceClpInvoker _clpInvoker = new JobServiceClpInvoker();
}