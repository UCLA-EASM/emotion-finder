...
import edu.ucla.macroscope.emotiongraph.service.DictionaryLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.ucla.macroscope.emotiongraph.service.impl.DictionaryLocalServiceImpl}.
 * </p>
 *
 * @author dave
 * @see edu.ucla.macroscope.emotiongraph.service.impl.DictionaryLocalServiceImpl
 * @see edu.ucla.macroscope.emotiongraph.service.DictionaryLocalServiceUtil
 * @generated
 */
public abstract class DictionaryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link edu.ucla.macroscope.emotiongraph.service.DictionaryLocalServiceUtil} to access the dictionary local service.
	 */
	...
	@Override
	public DictionaryContentsBlobModel getContentsBlobModel(
		Serializable primaryKey) throws SystemException {
		Session session = null;

		try {
			session = dictionaryPersistence.openSession();

			return (edu.ucla.macroscope.emotiongraph.model.DictionaryContentsBlobModel)session.get(DictionaryContentsBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw dictionaryPersistence.processException(e);
		}
		finally {
			dictionaryPersistence.closeSession(session);
		}
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("edu.ucla.macroscope.emotiongraph.model.Dictionary",
