...
import edu.ucla.macroscope.emotiongraph.service.JobDocumentResultLocalService;
...
/**
 * Provides the base implementation for the job document result local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edu.ucla.macroscope.emotiongraph.service.impl.JobDocumentResultLocalServiceImpl}.
 * </p>
 *
 * @author dave
 ...
 * @generated
 */
public abstract class JobDocumentResultLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements JobDocumentResultLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link edu.ucla.macroscope.emotiongraph.service.JobDocumentResultLocalServiceUtil} to access the job document result local service.
	 */
	...
	@Override
	public JobDocumentResult addJobDocumentResult(
		JobDocumentResult jobDocumentResult) throws SystemException {
		jobDocumentResult.setNew(true);

		return jobDocumentResultPersistence.update(jobDocumentResult);
	}
	 ...
	 */
	@Override
	public JobDocumentResult createJobDocumentResult(long jobDocumentResultId) {
		return jobDocumentResultPersistence.create(jobDocumentResultId);
	}
	...
	@Override
	public JobDocumentResult deleteJobDocumentResult(long jobDocumentResultId)
		throws PortalException, SystemException {
		return jobDocumentResultPersistence.remove(jobDocumentResultId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public JobDocumentResult deleteJobDocumentResult(
		JobDocumentResult jobDocumentResult) throws SystemException {
		return jobDocumentResultPersistence.remove(jobDocumentResult);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(JobDocumentResult.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return jobDocumentResultPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return jobDocumentResultPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public JobDocumentResult fetchJobDocumentResult(long jobDocumentResultId)
		throws SystemException {
		return jobDocumentResultPersistence.fetchByPrimaryKey(jobDocumentResultId);
	}
	 ...
	 */
	@Override
	public JobDocumentResult getJobDocumentResult(long jobDocumentResultId)
		throws PortalException, SystemException {
		return jobDocumentResultPersistence.findByPrimaryKey(jobDocumentResultId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return jobDocumentResultPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<JobDocumentResult> getJobDocumentResults(int start, int end)
		throws SystemException {
		return jobDocumentResultPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getJobDocumentResultsCount() throws SystemException {
		return jobDocumentResultPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public JobDocumentResult updateJobDocumentResult(
		JobDocumentResult jobDocumentResult) throws SystemException {
		return jobDocumentResultPersistence.update(jobDocumentResult);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("edu.ucla.macroscope.emotiongraph.model.JobDocumentResult",
			jobDocumentResultLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = jobDocumentResultPersistence.getDataSource();
	...
	private JobDocumentResultLocalServiceClpInvoker _clpInvoker = new JobDocumentResultLocalServiceClpInvoker();
}