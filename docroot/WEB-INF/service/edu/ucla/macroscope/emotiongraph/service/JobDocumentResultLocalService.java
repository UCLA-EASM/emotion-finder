...
/**
 * Provides the local service interface for JobDocumentResult. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author dave
 * @see JobDocumentResultLocalServiceUtil
...
public interface JobDocumentResultLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JobDocumentResultLocalServiceUtil} to access the job document result local service. Add custom service methods to {@link edu.ucla.macroscope.emotiongraph.service.impl.JobDocumentResultLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
